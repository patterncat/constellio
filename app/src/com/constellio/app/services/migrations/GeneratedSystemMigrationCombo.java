...
public final class GeneratedSystemMigrationCombo {
  ...
  public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
    ...
    MetadataBuilder temporaryRecord_importAudit_errors = temporaryRecord_importAuditSchema.create("errors").setType(MetadataValueType.STRING);
    temporaryRecord_importAudit_errors.setMultivalue(true);

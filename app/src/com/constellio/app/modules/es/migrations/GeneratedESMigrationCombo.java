...
public final class GeneratedESMigrationCombo {
  ...
  public void applyGeneratedSchemaAlteration(MetadataSchemaTypesBuilder typesBuilder) {
    ...
    connectorSmbDocument_parentConnectorUrl.setSystemReserved(true);
    ...
    connectorSmbDocument_parentConnectorUrl.setSearchable(true);
    ...
    connectorSmbFolder_connectorUrl.setSystemReserved(true);
    ...
    connectorSmbFolder_parentConnectorUrl.setSystemReserved(true);
  ...
  public void applySchemasDisplay(SchemasDisplayManager manager) {
    ...
    transaction.add(manager.getMetadata(collection, "connectorSmbDocument_default_path").withMetadataGroup("").withInputType(MetadataInputType.FIELD).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
    ...
    transaction.add(manager.getMetadata(collection, "connectorSmbFolder_default_path").withMetadataGroup("").withInputType(MetadataInputType.FIELD).withHighlightStatus(false).withVisibleInAdvancedSearchStatus(false));
